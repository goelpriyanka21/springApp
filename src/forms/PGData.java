...
public class PGData {
	...
	public List<JsonObject> validate() {
		...
		if (contactperson == null || contactperson.getName1() == null
			...
			errors.add(defineError("contactperson",
					PGDataErrMsgs.CONTACTPERSON_ERR));
		}
		...
		if (stdprofper != null
				&& (stdprofper.getstudper() + stdprofper.getprofper() != 100)) {
		...
		if (ageBand != null && ageBand.getminlimit() != null
				&& ageBand.getmaxlimit() != null
				&& ageBand.getminlimit() > ageBand.getmaxlimit()) {
			errors.add(defineError("ageBand", PGDataErrMsgs.AGEBAND_ERR));
		}
...
class PGDataErrMsgs {
	...
	static final String PGNAME_ERR = "pg name cannot be null/ empty/ more than 50 characters";
	static final String BUILDINGNAME_ERR = "buildingname name cannot be null/ empty/ more than 50 characters";
	static final String ADDRESSL1_ERR = "First Line Address cannot be null/ empty/ more than 200 characters";
	static final String ADDRESSL2_ERR = "Second Line Address cant be more than 200 characters";
	static final String PINCODE_ERR = "Pincode cannot be left blank/ should be 6 digits";
	static final String LANDMARK_ERR = "landmark cant be null/ empty/ more than 200 characters";
