...
public class AddNewFlatDataAPIJson {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    writer= new FileWriter("/Users/priyanka/git/grabhouse//AddNewFlatDataAPIJson.json"); 
		
		
	    
	    
	    	Location gpslocation= new Location(47.608941, -122.340145);
	    	SectionListOfFilePair sfp1= new SectionListOfFilePair("BedRoom",  Arrays.asList(new File("/Users/priyanka/RahejaFlatBedroom")));
	    	SectionListOfFilePair sfp2= new SectionListOfFilePair("Hall",  Arrays.asList(new File("/Users/priyanka/RahejaFlatHall1"), new File("/Users/priyanka/RahejaFlatBedroomHall2")));
	    	List<SectionListOfFilePair> picturelist= Arrays.asList(sfp1, sfp2);
	    	List<String> availableFor= Arrays.asList("Family", "Male Tenant", "Female Tenant");
	    	RatingAndListOfEs<String> amenities= new RatingAndListOfEs<>(3, Arrays.asList("AC", "PoojaRoom", "Cupboards"));
			...
			AddNewFlatData addNewFlatData = new AddNewFlatData(
					...
					"Springfields Apartment",
					 picturelist,  "603",
					 6,  2,  2,
					 "Semi-furnished",  "2BHK",  "East",
					 26500,  3000,  200000,
					 false,  availableFor,
					 amenities,  "None",
					 selectedlocation);
		...
		//POST: failure
		AddNewFlatData addNewFlatDatapost = new AddNewFlatData("Failure", "Token Authentication failed");
		...
		addNewFlatDatapost = new AddNewFlatData("Success", "Data successfully stored on server");
