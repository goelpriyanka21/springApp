...
public class AddNewPGTenantDataAPIJson {
	...
	public static void main(String[] args) throws IOException {
		...
		//GET
			...
			RatingAndListOfEs safety = new RatingAndListOfEs(4, Arrays.asList("Common area CCTV"));
			...
			RatingAndListOfEs commute = new RatingAndListOfEs(4, Arrays.asList("auto stand nearby", "bus stop nearby"));
			String bestPlacesToHangout = "Truffels";
			RatingAndListOfEs foodOptions = new RatingAndListOfEs(4, Arrays.asList("North Indian"));
			...
			AddNewPGTenantData addnewpgtenantdata= new AddNewPGTenantData("Priyanka",  "ba435a", gpslocation, "priyankatoken123", "Sri Sai Manasa PG", "Ram", "+91-9877812345", "ram@gmail.com", 25, "Software Professional",  threebestthings, threethingsyoudontlikeaboutPG, safety, "None", cleanliness, otherRoommates, commute, bestPlacesToHangout, foodOptions, foodqualityrating, ownerAndServiceFeedBack, ownerInteractionReview,  ownerflexibility, rentPaymentMode, serviceReview, referralpossibilty, servicesInterested, additionalComments, selectedlocation);  
